            ...
            <div class="card-body job-list-card-body" style="background-color: #d6ebf1;">
                <div class="job-list-body" id="job-content-area">           
                    <div class="card-header" style="height: 50px; border-radius: 0px 0px 10px 10px;">
                        <div class="card-title text-center" style="font-weight: 500; color: green; font-size: 20px;border-bottom: 1px solid #559ce3;">PTC Running Job that You Posted</div>
                        <div class="card-title text-center">
                            <strong></strong>
                        </div>
                    </div>                    
                    @forelse ($jobs as $job)
                        <a href="{{route('user.ptcEdit',$job->id)}}" class="">
