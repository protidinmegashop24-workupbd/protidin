        ...
        <div class="col-md-6 col-lg-6 col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">New Investment For {{$package->title}}</h4>
                </div>
                <div class="card-body">
                    <div class="mb-2">
                        <a href="{{route('user.investment-create-from-earning', $package->id)}}" class="btn btn-sm btn-info mb-2">Package Book From Earning</a>
                        <a href="{{route('user.investment-create-from-deposit', $package->id)}}" class="btn btn-sm btn-success mb-2">Package Book From Deposit</a>
                    </div>
                        ...
                        <div class="">
                            ...
                            <div id="deposit_area" style="display: none;">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" readonly type="number" name="amount" value="{{$package->invest_amount}}" min="0" step="0.0001" placeholder="Deposit Amount">
                                </div>
