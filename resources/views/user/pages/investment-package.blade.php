                    ...
                    <div class="card">
                        ...
                        <div class="card-body Promoter Award_body">
                            ...
                            <span style="color: #3498DB;">
                                <p class="m-0"><i class="fas fa-check-circle text-blue"></i>&nbsp;&nbsp; Invest Amount {{$package->invest_amount}}$</p>
                                <p class="m-0"><i class="fas fa-check-circle text-green"></i> &nbsp;&nbsp;Profit {{$package->profit_per}}%</p>
                                <p class="m-0"><i class="fas fa-check-circle text-blue"></i>&nbsp;&nbsp; {{$package->duration}}Days</p>
                                @php
                                    $total = $package->invest_amount + ($package->invest_amount * $package->profit_per)/100;
                                @endphp
                                <p class="m-0"><i class="fas fa-check-circle text-green"></i> &nbsp;&nbsp;Amount With Profit: {{$total}}$</p>
                                <div class="text-center">
                                    <hr>
                                    <button class="btn btn-primary" onclick="buySelect('{{$package->id}}','{{$package->title}}','{{$package->invest_amount}}')"><i class="fa fa-cart-plus"></i> Buy Package</button>
                                </div>
                            </span>
                        </div>
                    </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <br>
                            <p>
                                <b>Package:</b> <span id="txt_pkg_type">Essential</span>
                                <br>
...
@section('js')
    <script>
        ...
        $(document).on('click', '#btnBuyConfirm', function () {
            ...
            jQuery.ajax({
                url: "{{ route('user.investment-buy-confirm') }}",
                type: "POST",
