...
@section('user-content')
    ...
    <div class="card card-body mt-2 p-3" style="background-color: rgb(248, 249, 254);height: auto !important;">
        <div class="card-header row">
            <div class="card-title col-md-6 col-12 text-center" style="font-weight: 500; color: green; font-size: 20px;">Service Packages</div>
    ...
    color: #fff;"><i class="fas fa-search"></i>&nbsp;Search</span>
        ...
        <div class="row justify-content-center">
            @foreach($service_items as $package)
                    ...
                    <div class="card">
                        ...
                        <div class="card-body Promoter Award_body">
                            <div class="package-area mb-2">
                                <a href="{{route('user.service-item-details',$package->id)}}" target="_blank">
                                    <img src="{{URL::to($package->image)}}" width="100%">
                                </a>
                            </div>
                            <span>
                                <p class="m-0 mt-1" style="color: #3498DB;    font-size: 25px;"><a href="{{route('user.service-item-details',$package->id)}}" target="_blank">Details</a></p>
                                ...
                                <div class="text-center">
                                    <hr>
                                    <button class="btn btn-primary" onclick="buySelect('{{$package->id}}','{{$package->title}}','{{$package->price}}')"><i class="fa fa-cart-plus"></i> Buy Package</button>
                                </div>
                            </span>
                        </div>
                    </div>
