        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="@if(Auth::user()->status == 0) javascript:; @else {{ route('user.review') }} @endif" @if(Auth::user()->status == 0) onclick="return alert('Your Account is blocked! {{ Auth::user()->reason }}. Please Contact with authority!')" @endif><i class="mdi mdi-star font-size-17 align-middle me-1"></i> Rate &amp; Review </a>
                    <div class="dropdown-divider"></div>
