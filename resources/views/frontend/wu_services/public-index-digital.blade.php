        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="mp-hero-content">
                    <span class="mp-badge">Protidin Mega Earn Digital Products</span>
                    <h1>Buy and Sell Digital Products Instantly</h1>
                    <p>
                        Explore ready-made digital products -- templates, scripts, ebooks, graphics and more --
                        with instant download after purchase, no waiting for delivery.
                        Protidin Mega Earn Marketplace helps users start, grow, and manage digital product sales with confidence.
                    </p>

                    <ul class="mp-hero-points">
                        <li>✔ Discover ready-made digital products</li>
                        <li>✔ Instant download after purchase</li>
                        <li>✔ Secure payment with protected transactions</li>
                        <li>✔ No waiting for delivery -- get the file right away</li>
    ...
    <section class="wu-section">
        <div class="container">
            <div class="wu-section-title">
                ...
                <p>
                    Browse live digital product listings and open a product page to learn more before purchasing and downloading instantly.
                </p>
            </div>
<form method="GET" action="{{ url()->current() }}" class="wu-search-bar">
    <input type="text" name="q" placeholder="Search digital products..." value="{{ request('q') }}">
...
<div class="text-center mb-4">
    ...
    @endforeach
            ...
            <div class="row">
                ...
                @empty
                    <div class="col-12">
                        <div class="alert alert-info">No digital products are available right now.</div>
                    </div>
                @endforelse
            </div>
    ...
    <section class="wu-section">
        <div class="container">
            <div class="wu-section-title">
                <h2>Popular digital product categories</h2>
                <p>
