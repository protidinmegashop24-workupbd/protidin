            ...
            @foreach ($services as $item=>$service)
                <div class="col-md-4 single-item">
                    <div class="item bg-light">
                        <div class="thumb">
                            <a href="{{ route('service_details',$service->slug) }}"><img src="{{ URL::to($service->image) }}" alt="Thumb"></a>
                        </div>
                        <div class="info">
                            <h4>
                                <a href="{{ route('service_details',$service->slug) }}">{{ $service->name }}</a>
                            </h4>
                            {{-- <p>
                                {!! $service->details !!}
                            </p> --}}
                            {{-- <div class="meta">
                                ...
                                <a href="{{ route('service_details',$service->slug) }}">Read More</a>
                            </div> --}}
                        </div>
                    </div>
                </div>
