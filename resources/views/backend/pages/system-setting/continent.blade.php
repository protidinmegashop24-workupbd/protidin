                                    ...
                                    @foreach ($datas as $key => $data)
                                        ...
                                        <div class="modal fade" id="edit_{{ $key }}" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <form action="{{ route('admin.continent.update', $data->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Update <strong>{{ $data->name }}</strong></h5>
                                                        ...
                                                        <div class="modal-body row">
                                                            <div class="form-group col-lg-12 col-md-12 col-12">
                                                                ...
                                                                <input type="text" class="form-control" name="name" required value="{{ $data->name }}" placeholder="Name">
                                                            </div>
                                                        </div>
