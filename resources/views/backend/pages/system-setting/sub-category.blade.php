        ...
        <div class="container-fluid">
            <div class="row">
                                ...
                                <tbody>
                                    @foreach ($sub_categorys as $key => $s_category)
                                        <tr>
                                            ...
                                            <td>{{ main_category($s_category->category_id) }}</td>
                                            <td>{{ $s_category->minimum_cost }}</td>
                                            <td>
                                        ...
                                        <div class="modal fade" id="edit_{{ $key }}" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <form action="{{ route('admin.job-sub-category.update', $s_category->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body row">
                                                            ...
                                                            <div class="form-group col-lg-12 col-md-12 col-12">
                                                                ...
                                                                <input type="text" class="form-control" id="categoryName" name="name" required value="{{ $s_category->name }}" placeholder="Category Name">
                                                            </div>
                                                            <div class="form-group col-lg-12 col-md-12 col-12">
                                                                <label for="minimum_cost">Minimum Job Cost</label>
                                                                <input type="text" class="form-control" id="minimum_cost" name="minimum_cost" required value="{{ $s_category->minimum_cost }}">
                                                            </div>
                                                        </div>
                ...
                <div class="col-lg-5 col-5">
                    <form action="{{ route('admin.job-sub-category.store') }}" method="POST">
                        @csrf
                        <div class="card card-primary">
                            ...
                            <div class="card-body row">
                                ...
                                <div class="form-group col-lg-12 col-md-12 col-12">
                                    <label for="minimum_cost">Minimum Job Cost</label>
                                    <input type="text" class="form-control" id="minimum_cost" name="minimum_cost" required value="0">
                                </div>
                            </div>
