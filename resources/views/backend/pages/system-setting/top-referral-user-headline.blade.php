        ...
        <div class="container-fluid">
            <div class="row">
                                    ...
                                    @foreach ($headlines as $key => $headline)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form id="delete-form-{{ $headline->id }}" action="{{ route('admin.top-referral-user-headline.delete', $headline->id) }}" method="POST" style="display: none;">
                                                    @csrf
                                                </form>
                                            </td>
                                        </tr>
                ...
                <div class="col-lg-5 col-5">
                    <form action="{{ route('admin.top-referral-user-headline.store') }}" method="POST">
                        @csrf
