<div class="modal fade" id="edit_{{$abouts->id}}">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header bg-success">
          <h4 class="modal-title"><i class="fas fa-plus"></i> Update About Us</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
            <form action="{{ route('admin.about_us.update',$abouts->id) }}" method="POST" novalidate="novalidate" enctype="multipart/form-data">
                @csrf
                <div class="row">
                ...
                <div class="form-group col-lg-12 col-md-12 col-12">
                    ...
                    <div class="input-group">
                        <img src="{{ URL::to($abouts->image) }}" class="thumb-lg img-thumbnail" alt="Feature Image" name="old_photo" height="100px" width="100px">
                    </div>
                </div>
