<div class="modal fade" id="edit_{{$career->id}}">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{ route('admin.career.update',$career->id) }}" method="POST" novalidate="novalidate" enctype="multipart/form-data">
                @csrf
                <div class="row">
                ...
                <div class="form-group col-lg-12 col-md-12 col-12">
                    ...
                    <div class="input-group">
                        <img src="{{ URL::to($career->image) }}" class="thumb-lg img-thumbnail" alt="Feature Image" name="old_photo" height="100px" width="100px">
                    </div>
                </div>
