...
@section('title')
    Offer Wall Conversions - Dashboard
@endsection
...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Offer Wall Conversions</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
            <li class="breadcrumb-item"><a href="{{ route('admin.offer-wall-providers') }}">Offer Wall Providers</a></li>
...
<section class="content">
    <div class="container-fluid">
        <div class="alert alert-info">
            Rows with status <strong>unverified</strong> are raw postbacks that have been logged but NOT
            credited to any wallet -- the "Amount" and "User" columns for those rows are best-effort guesses
            at the field names, not confirmed. Check <code>raw_payload</code> (or the server log) to see
        ...
        <div class="row mb-3">
            <div class="col-md-4">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Total Approved (credited)</span>
            ...
            <div class="col-md-4">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Unverified (not credited)</span>
                        <span class="info-box-number">{{ $totals['unverified'] }}</span>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                ...
                <form method="GET" class="form-row mb-3">
                    ...
                    <div class="form-group col-md-3">
                        <select name="status" class="form-control">
                            ...
                            <option value="unverified" @if(request('status')=='unverified') selected @endif>Unverified</option>
