      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            @if (Auth::user()->role_id == 1)            
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.community-reports') }}" class="nav-link {{ Route::is('admin.community-reports') ? 'active' : '' }}">
                ...
                @endif
                <li class="nav-item">
                    <a href="{{ route('admin.community-topics') }}" class="nav-link {{ Route::is('admin.community-topics') ? 'active' : '' }}">
                        <i class="fa fa-tags" aria-hidden="true"></i>
                        <p>&nbsp;Community Topics</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('admin.survey-providers') }}" class="nav-link {{ Route::is('admin.survey-providers*') ? 'active' : '' }}">
                        <i class="fa fa-poll-h" aria-hidden="true"></i>
                        <p>&nbsp;Survey Providers</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('admin.offer-wall-providers') }}" class="nav-link {{ Route::is('admin.offer-wall-providers*') ? 'active' : '' }}">
