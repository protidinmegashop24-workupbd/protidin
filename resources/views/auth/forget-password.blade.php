...
<style>
    ...
    .wu-btn{
        ...
        font-weight: 800;
        font-size: 15px;
        box-shadow: 0 10px 24px rgba(34, 171, 89, 0.18);
    }
    ...
    <div class="container">
        <div class="wu-auth-card">
            <div class="wu-auth-header">
                ...
                <p>Enter your account email address. A 6 digit OTP will be sent to your email.</p>
            </div>
            ...
            <div class="wu-auth-body">
                ...
                <form action="{{ route('recover-password') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="email" name="email" class="wu-input" value="{{ old('email') }}" placeholder="Enter your email address" required>
                    </div>
