...
class DefaultController extends Controller
{
    ...
    public function index()
    {
        ...
        $schreen_shoot_charge = ScreenShootCharge::latest()->first();
        $website = Website::latest()->first();
        return view('backend.pages.system-setting.deafult-setup', compact('wc_bonus', 'website','main_wallet', 'dollar_rate', 'jobFee', 'depositFee', 'withdrawFee','schreen_shoot_charge'));
    }
    ...
    public function job_fee(Request $request, $id)
    {
        ...
        $jobFee->min_fee = $request->min_fee;
        $jobFee->job_delete_fee = $request->job_delete_fee;
        $jobFee->save();

        return redirect()->back()->with('message','Data updated Successfully');
    }

    public function screenshot_charge_update(Request $request, $id)
    {
        $data = ScreenShootCharge::find($id);
